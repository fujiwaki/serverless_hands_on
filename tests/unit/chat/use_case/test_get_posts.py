...
from chat.use_case import GetPosts, GetPostsCommand, PostDTO
...
class TestGetPosts:
    ...
    def test_execute_with_all_posts(self, post_repository: InMemoryPostRepository) -> None:
        ...
        command = GetPostsCommand(thread_id=thread_id)
        use_case = GetPosts(post_repository)
    ...
    def test_execute_with_no_posts(self, post_repository: InMemoryPostRepository) -> None:
        ...
        command = GetPostsCommand(thread_id="01DXF6DT000000000000000000")
        use_case = GetPosts(post_repository)
    ...
    def test_execute_with_start_time(self, post_repository: InMemoryPostRepository) -> None:
        ...
        command = GetPostsCommand(thread_id=thread_id, start_time=datetime(2020, 1, 3, tzinfo=UTC))
        use_case = GetPosts(post_repository)
    ...
    def test_execute_with_start_time_no_posts(self, post_repository: InMemoryPostRepository) -> None:
        ...
        command = GetPostsCommand(thread_id=thread_id, start_time=datetime(2020, 1, 4, tzinfo=UTC))
        use_case = GetPosts(post_repository)
